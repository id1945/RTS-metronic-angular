...
@Component({
  selector: 'app-form-bussinesstype-modal',
  templateUrl: './form-bussinesstype-modal.component.html',
  styleUrls: ['./form-bussinesstype-modal.component.scss']
})
export class FormBussinesstypeModalComponent implements OnInit {
  ...
  private initForm() {
    this.formGroup = new FormGroup({
      tenLoaiNghiepVu: new FormControl('', Validators.required)
    })
  }
  ...
  public onCreate() {
    ...
    if (this.formGroup.valid) {
      ...
      // Call api
      this.api.post(`/api/loai-nghiep-vu-create`, bodyParam).subscribe(
        res => {
          if (res) {
            swal({
              icon: "success",
