...
import { FormBussinesstypeModalComponent } from './components/form-bussinesstype-modal/form-bussinesstype-modal.component';
import { Options } from 'src/app/_metronic/shared/shared/models/options';
import { DataTable, Columns } from 'src/app/_metronic/shared/shared/models/dataTable';

@Component({
  selector: 'app-bussinesstype-list',
  templateUrl: './bussinesstype-list.component.html',
  styleUrls: ['./bussinesstype-list.component.scss']
})
export class BussinesstypeListComponent implements OnInit {
  ...
  @ViewChild('formExpressDelivery', { static: false }) formExpressDelivery: FormBussinesstypeModalComponent;
  ...
  public getList() {
    ...
    this.api.get('/api/loai-nghiep-vu-list', query).subscribe(res => {
      if (res) {
   ...
   */
   public onDelete(Id) {
    this.api.delete(`/api/loai-nghiep-vu-delete?LoaiNghiepVuid=${Id }`)
      .subscribe((res: any) => {
        if (res?.isSuccess) {
          swal({
            icon: "success",
