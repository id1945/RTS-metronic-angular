...
@Component({
  selector: 'app-form-vehicle-modal',
  templateUrl: './form-vehicle-modal.component.html',
  styleUrls: ['./form-vehicle-modal.component.scss']
})
export class FormVehicleModalComponent implements OnInit {
  ...
  private initForm() {
    this.formGroup = new FormGroup({
      ...
      khuVucId: new FormControl(),
      quyenSoHuu: new FormControl(),
  ...
  public onCreate() {
    ...
    if (this.formGroup.valid) {
      ...
      // Call api
      this.api.post(`/danh-sach-xe-create`, bodyParam).subscribe(
        res => {
          if (res) {
            swal({
              icon: "success",
