...
import { FormDepartmentModalComponent } from './components/form-department-modal/form-department-modal.component';
...
export class DepartmentListComponent implements OnInit {
  ...
  @ViewChild('formExpressDelivery', { static: false }) formExpressDelivery: FormDepartmentModalComponent;
  ...
  public getList() {
    ...
    this.api.get('/api/phong-ban-list', query).subscribe(res => {
      if (res) {
   ...
   */
   public onDelete(Id) {
    this.api.delete(`/api/phong-ban-delete?PhongBanId=${Id }`)
      .subscribe((res: any) => {
        if (res?.isSuccess) {
          swal({
            icon: "success",
