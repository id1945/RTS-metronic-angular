...
import { FormPositionModalComponent } from './components/form-position-modal/form-position-modal.component';
...
export class PositionListComponent implements OnInit {
  ...
  @ViewChild('formExpressDelivery', { static: false }) formExpressDelivery: FormPositionModalComponent;
  ...
  public getList() {
    ...
    this.api.get('/api/chuc-vu-list', query).subscribe(res => {
      if (res) {
   ...
   */
  public onDelete(Id) {
    this.api.delete(`/api/chuc-vu-delete?ChucVuid=${Id }`)
      .subscribe((res: any) => {
        if (res?.isSuccess) {
          swal({
            icon: "success",
