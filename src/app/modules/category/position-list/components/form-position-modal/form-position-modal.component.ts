...
@Component({
  selector: 'app-form-position-modal',
  templateUrl: './form-position-modal.component.html',
  styleUrls: ['./form-position-modal.component.scss']
})
export class FormPositionModalComponent implements OnInit {
  ...
  public onCreate() {
    ...
    if (this.formGroup.valid) {
      ...
      // Call api
      this.api.post(`/api/chuc-vu-create`, bodyParam).subscribe(
        res => {
          if (res) {
            swal({
              icon: "success",
