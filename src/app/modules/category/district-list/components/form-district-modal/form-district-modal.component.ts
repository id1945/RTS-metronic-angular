...
@Component({
  selector: 'app-form-district-modal',
  templateUrl: './form-district-modal.component.html',
  styleUrls: ['./form-district-modal.component.scss']
})
export class FormDistrictModalComponent implements OnInit {
  ...
  private initForm() {
    this.formGroup = new FormGroup({
      maQuanHuyen: new FormControl('', Validators.required),
      tenQuanHuyen: new FormControl('', Validators.required),
  ...
  public onCreate() {
    ...
    if (this.formGroup.valid) {
      ...
      // Call api
      this.api.post(`/api/quan-huyen-create`, bodyParam).subscribe(
        res => {
          if (res) {
            swal({
              icon: "success",
