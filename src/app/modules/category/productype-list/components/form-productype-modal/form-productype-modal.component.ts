...
@Component({
  selector: 'app-form-productype-modal',
  templateUrl: './form-productype-modal.component.html',
  styleUrls: ['./form-productype-modal.component.scss']
})
export class FormProductypeModalComponent implements OnInit {
  ...
  private initForm() {
    this.formGroup = new FormGroup({
      maNhomSanPham: new FormControl('', Validators.required),
      tenNhomSanPham: new FormControl('', Validators.required),
  ...
  public onCreate() {
    ...
    if (this.formGroup.valid) {
      ...
      // Call api
      this.api.post(`/api/nhom-san-pham-create`, bodyParam).subscribe(
        res => {
          if (res) {
            swal({
              icon: "success",
