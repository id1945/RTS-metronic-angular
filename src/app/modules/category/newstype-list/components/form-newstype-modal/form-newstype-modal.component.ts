...
@Component({
  selector: 'app-form-newstype-modal',
  templateUrl: './form-newstype-modal.component.html',
  styleUrls: ['./form-newstype-modal.component.scss']
})
export class FormNewstypeModalComponent implements OnInit {
  ...
  private initForm() {
    this.formGroup = new FormGroup({
      tenNhomBaiViet: new FormControl('', Validators.required),
      maNhomBaiViet: new FormControl('', Validators.required),
  ...
  public onCreate() {
    ...
    if (this.formGroup.valid) {
      ...
      // Call api
      this.api.post(`/api/nhom-bai-viet-create`, bodyParam).subscribe(
        res => {
          if (res) {
            swal({
              icon: "success",
