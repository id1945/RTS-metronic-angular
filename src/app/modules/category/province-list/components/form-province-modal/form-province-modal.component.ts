...
@Component({
  selector: 'app-form-province-modal',
  templateUrl: './form-province-modal.component.html',
  styleUrls: ['./form-province-modal.component.scss']
})
export class FormProvinceModalComponent implements OnInit {
