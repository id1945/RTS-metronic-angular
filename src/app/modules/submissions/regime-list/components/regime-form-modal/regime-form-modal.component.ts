...
@Component({
  selector: 'app-regime-form-modal',
  templateUrl: './regime-form-modal.component.html',
  styleUrls: ['./regime-form-modal.component.scss']
})
export class RegimeFormModalComponent {
