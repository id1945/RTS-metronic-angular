...
import { InternalReportFormModalComponent } from './components/internalreport-form-modal/internalreport-form-modal.component';
import { ApiService } from 'src/app/_metronic/shared/http/api.service';
import { DataTable, Columns } from 'src/app/_metronic/shared/shared/models/dataTable';

@Component({
  selector: 'app-internalreport-list',
  templateUrl: './internalreport-list.component.html',
  styleUrls: ['./internalreport-list.component.scss']
})
export class InternalReportListComponent implements OnInit {
  ...
  @ViewChild('regimeForm', { static: false }) regimeForm: InternalReportFormModalComponent;
