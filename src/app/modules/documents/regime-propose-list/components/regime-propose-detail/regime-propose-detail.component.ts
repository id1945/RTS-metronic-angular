...
import { ApproveRegimeProposeModalComponent } from './approve-regime-propose-modal/approve-regime-propose-modal.component';

@Component({
  selector: 'app-regime-propose-detail',
  templateUrl: './regime-propose-detail.component.html',
  styleUrls: ['./regime-propose-detail.component.scss']
})
export class RegimeProposeDetailComponent implements OnInit {

  @ViewChild('appApproveModal', { static: false }) appApproveModal: ApproveRegimeProposeModalComponent;
