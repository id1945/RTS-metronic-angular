...
import { FormFlowsModalComponent } from './components/form-flows-modal/form-flows-modal.component';
...
export class FlowsListComponent implements OnInit {
  ...
  @ViewChild('formExpressDelivery', { static: false }) formExpressDelivery: FormFlowsModalComponent;
  ...
  constructor(
    ...
    this.dataTable.columns = [
      {
        field: 'quyTrinhId',
        sortField: 'quyTrinhId',
        title: 'Quy trình Id',
        width: '150px',
      },
      {
        field: 'maQuyTrinh',
        sortField: 'maQuyTrinh',
        title: 'Mã quy trình',
        width: '150px',
      },
      {
        field: 'tenQuyTrinh',
        sortField: 'tenQuyTrinh',
        title: 'Tên quy trình',
        width: '250px',
      },
      {
  ...
  public getList() {
    ...
    this.api.get('/api/quytrinh-list', query).subscribe(res => {
      if (res) {
