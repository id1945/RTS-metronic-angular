...
@Component({
  selector: 'app-photo-library-list',
  templateUrl: './photo-library-list.component.html',
  styleUrls: ['./photo-library-list.component.scss']
})
export class PhotoLibraryListComponent implements OnInit {
