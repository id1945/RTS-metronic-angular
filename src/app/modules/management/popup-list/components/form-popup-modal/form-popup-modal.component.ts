...
@Component({
  selector: 'app-form-popup-modal',
  templateUrl: './form-popup-modal.component.html',
  styleUrls: ['./form-popup-modal.component.scss']
})
export class FormPopupModalComponent implements OnInit {
