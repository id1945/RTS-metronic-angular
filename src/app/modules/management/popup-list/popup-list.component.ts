...
import { FormPopupModalComponent } from './components/form-popup-modal/form-popup-modal.component';
...
export class PopupListComponent implements OnInit {
  ...
  @ViewChild('formExpressDelivery', { static: false }) formExpressDelivery: FormPopupModalComponent;
  ...
  constructor(
    ...
    this.dataTable.columns = [
      ...
      },
      {
        ...
        sortField: 'thoiGianBatDau',
        title: 'Thời gian bắt đầu',
        width: '150px',
      },
      {
        field: 'thoiGianKetThuc',
        sortField: 'thoiGianKetThuc',
