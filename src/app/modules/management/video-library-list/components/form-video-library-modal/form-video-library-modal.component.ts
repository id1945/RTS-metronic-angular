...
@Component({
  selector: 'app-form-video-library-modal',
  templateUrl: './form-video-library-modal.component.html',
  styleUrls: ['./form-video-library-modal.component.scss'],
  exportAs: 'video-library'
})
export class FormVideoLibraryModalComponent implements OnInit {
