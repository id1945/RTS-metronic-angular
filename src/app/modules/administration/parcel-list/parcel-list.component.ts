import { DetailParcelModalComponent } from './../parcel-list/components/detail-parcel-modal/detail-parcel-modal.component';
...
export class ParcelListComponent implements OnInit {
  ...
  public getList() {
    ...
    this.api.get('/api/buupham-list/cua-toi', query).subscribe(res => {
      if (res) {
