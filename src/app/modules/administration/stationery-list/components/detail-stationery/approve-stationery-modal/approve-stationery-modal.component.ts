...
@Component({
  selector: 'app-approve-stationery-modal',
  templateUrl: './approve-stationery-modal.component.html',
  styleUrls: ['./approve-stationery-modal.component.scss']
})
export class ApproveStationeryModalComponent implements OnInit {
  ...
  async onSubmitApprove() {
    ...
    const url = this.IsAccept ? '/api/hoso-vanphongpham-create/phe-duyet' : '/api/hoso-vanphongpham-create/tu-choi';
    const bodyParams = {
