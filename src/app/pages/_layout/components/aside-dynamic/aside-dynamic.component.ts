...
import { LayoutService, DynamicAsideMenuService } from 'src/app/_metronic/core';
...
export class AsideDynamicComponent implements OnInit, OnDestroy {
  ...
  private getLogo() {
    if (this.brandSkin === 'light') {
      ...
      return './assets/media/logos/HTV_Logo_Horizontal_White_RGB.png';
      // return './assets/media/svg/logos/tc-motor.svg';
    }
  }
